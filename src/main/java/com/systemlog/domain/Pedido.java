...
public class Pedido implements Serializable {
	...
	//@JsonManagedReference // O cliente do pedido será serializado na chamada do serviço 
	@OneToOne(cascade=CascadeType.ALL, mappedBy = "pedido")
	private Pagamento pagamento;

	//@JsonManagedReference  O cliente do pedido será serializado na chamada do serviço ( retirado devido o curso ) 
	@ManyToOne
	...
	public String toString() {
		...
		builder.append(format.format(getInstante()));
		builder.append(", Cliente: ");
		builder.append(getCliente().getNome());
		builder.append(", Situação pagamento: ");
		builder.append(getPagamento().getEstado().getLabelPagamento());
		builder.append("\nDetalhes:\n");
